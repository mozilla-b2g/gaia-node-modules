...
function detectURL(options) {
  var nsparts, buildname, ns, index, task, queue, _ref, artifacts, os, suffix, artifact;
  ...
  return regeneratorRuntime.async(function detectURL$(context$1$0) {
    while (1) switch (context$1$0.prev = context$1$0.next) {
      ...
      case 11:
        ...
        os = options.os;
        suffix = !!options.fileSuffix ? options.fileSuffix : buildinfo.archiveFileSuffix(os);
